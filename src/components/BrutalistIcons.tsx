export const Sparkle = ({ className = "" }) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M50 0C50 27.6142 27.6142 50 0 50C27.6142 50 50 72.3858 50 100C50 72.3858 72.3858 50 100 50C72.3858 50 50 27.6142 50 0Z" fill="currentColor" stroke="#111111" strokeWidth="6" strokeLinejoin="round"/>
  </svg>
);

export const CircleSticker = ({ className = "" }) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <circle cx="50" cy="50" r="45" fill="currentColor" stroke="#111111" strokeWidth="6"/>
  </svg>
);
...
export const PillSticker = ({ className = "" }) => (
  <svg viewBox="0 0 100 50" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <rect x="5" y="5" width="90" height="40" rx="20" fill="currentColor" stroke="#111111" strokeWidth="6"/>
    <line x1="50" y1="5" x2="50" y2="45" stroke="#111111" strokeWidth="6"/>
  </svg>
);
...
export const SmileNeo = ({ className = "" }) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <circle cx="50" cy="50" r="45" fill="currentColor" stroke="#111111" strokeWidth="6"/>
    <circle cx="35" cy="40" r="5" fill="#111111"/>
    <circle cx="65" cy="40" r="5" fill="#111111"/>
    <path d="M30 65C40 75 60 75 70 65" stroke="#111111" strokeWidth="6" strokeLinecap="round"/>
  </svg>
);
